...
# VERSION here before cutting a release. BUILD_DATE is overwritten by the workflow
# to the day the image is built (America/Los_Angeles).
VERSION = "1.0.1"
...
# Default loop count for live-event GIFs; per-event overrides in LiveScene.
LIVE_ANIM_LOOPS = _env_clamp_int("BIGA_LIVE_ANIM_LOOPS", 3, lo=1, hi=10)
